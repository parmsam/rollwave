...
const primaryButtonClass =
  'rounded-full bg-accent px-10 py-4 text-lg font-semibold text-ink shadow-[0_0_30px_-5px_var(--color-accent)] transition active:scale-95'
const secondaryButtonClass =
  'rounded-full border border-white/15 px-6 py-4 text-sm font-medium text-white/80 transition hover:border-white/30 active:scale-95'
